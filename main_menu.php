        ...
        <div class="row justify-content-center">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/social_image.png" class="card-img-top" alt="Social Image">
                    <div class="card-body">
            ...
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/linkedin.png" class="card-img-top" alt="Advertisement Photo">
                    <div class="card-body">
                        <h5 class="card-title">LinkedIn Jobs</h5>
                        <p class="card-text">Get your desired job that you always wished for.</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="linked_in_jobs_page.php">View Jobs</a> </div>
                </div>
            </div>

            <!-- Alumni Opportunities Hub -->
            <div class="col-auto mb-5 mx-auto">
                <div class="card text-center">
                    <img src="images/opportunity_hub.png" class="card-img-top" alt="Advertisement Photo">
                    <div class="card-body">
                        <h5 class="card-title">Alumni Opportunities Hub</h5>
                        <p class="card-text">Get your desired job that you always wished for.</p>
                    </div>
                    <div class="d-grid gap-2"> <a role="button" class="btn card-btn btn-primary fw-medium py-2" href="alumni_opportunities.php">View Jobs</a> </div>
                </div>
            </div>
